                            ...
                            <div class="card-body">
                                <form action="/athletes" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control" placeholder="Masukkan nama atlet..." required />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="weight" class="form-control" placeholder="Masukkan berat badan atlet..." required />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="height">Tinggi Badan (cm)</label>
                                        <div class="col-sm-10">
                                            <input type="number" name="height" class="form-control" placeholder="Masukkan tinggi badan atlet..." required />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
